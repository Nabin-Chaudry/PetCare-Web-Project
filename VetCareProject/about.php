            ...
            <div class="row">
                <div class="col-md-3 col-sm-2 col-xs-12">
                    <div class="aboutus mb-5">
                        ...
                        <br>
                        <div class="about1">
                        <img src="assets/about2.jpg"  width="590px" height="auto" alt="dog healthcare personnel">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="aboutus-banner">
                        <img src="assets/about1.jpg" width="260px" height="auto" alt="dog healthcare personnel">
                    </div>
                </div>
